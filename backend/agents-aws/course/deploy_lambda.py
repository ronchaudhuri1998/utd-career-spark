#!/usr/bin/env python3
"""
Automated Lambda deployment for Course Catalog tools
"""
...
FUNCTION_NAME = "UTD-CourseCatalogTools"
ROLE_NAME = "UTD-CourseCatalogToolsLambdaRole"
...
def create_deployment_package():
    ...
    shutil.copy("lambda_course_tools.py", package_dir)

    # Create ZIP
    zip_path = "course_catalog_tools_lambda.zip"
...
def deploy_lambda_function(role_arn, zip_path):
    ...
    try:
        ...
        response = lambda_client.create_function(
            ...
            Runtime="python3.11",
            Role=role_arn,
            Handler="lambda_course_tools.lambda_handler",
            Code={"ZipFile": zip_content},
            Timeout=30,  # 30 seconds for course data
            MemorySize=256,
            Description="Course catalog tools for UTD Career Spark course data",
        )
...
def main():
    print("=" * 60)
    print("Deploying Course Catalog Tools Lambda Function")
    print("=" * 60)
    ...
    print(f"LAMBDA_COURSE_CATALOG_TOOLS_ARN={function_arn}")
